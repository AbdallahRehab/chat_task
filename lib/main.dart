...
import 'package:full_chat_application/presentation/controllers/home_cubit/home_cubit.dart';
import 'package:full_chat_application/presentation/screens/home_layout_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    child:GetMaterialApp(
        ...
        getPages: [
          ...
          GetPage(name: '/home_layout', page: () =>  HomeLayoutScreen()),
        ],
    ),);
  }
